...
//    @GameRegistry.ObjectHolder("entity.trumpet_skeleton.ambient")
    public static final String ENTITY_TRUMPET_SKELETON_AMBIENT = TrumpetSkeleton.MODID + ":entity.trumpet_skeleton.ambient";
...
//    @GameRegistry.ObjectHolder("item.trumpet.use")
    public static final String ITEM_TRUMPET_USE = TrumpetSkeleton.MODID + ":item.trumpet.use";
}
